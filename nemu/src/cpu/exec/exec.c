...
make_group(gp2,
  ...
  /* 0xf6, 0xf7 */
make_group(gp3,
    IDEX(test_I, test), IDEX(test_I, test), EX(not), EX(neg),
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x84 */	IDEXW(G2E, test, 1), IDEX(G2E, test), IDEXW(E2G, xchg, 1), IDEX(E2G, xchg),
  ...
  /* 0x90 */	EX(nop), IDEX(r, xchg), IDEX(r, xchg), IDEX(r, xchg),
  /* 0x94 */	IDEX(r, xchg), IDEX(r, xchg), IDEX(r, xchg), IDEX(r, xchg),
  ...
  /* 0xb8 */	EMPTY, EMPTY, IDEXW(mov_E2G, movsx, 1), IDEX(mov_E2G, movsx),
